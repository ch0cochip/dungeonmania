...
import dungeonmania.entities.enemies.EnemyHealthStrategy;
import dungeonmania.entities.enemies.HealthStrategy;
...
public class BattleStatistics {
    ...
    // private MyStrategy strategy = null;
    private HealthStrategy healthStrategy = new EnemyHealthStrategy();
    ...
    public static List<BattleRound> battle(BattleStatistics self, BattleStatistics target) {
        ...
        while (self.getHealth() > 0 && target.getHealth() > 0) {
            ...
            target.healthStrategy.healthStrategy(target, damageOnTarget);
