...
public class Inventory {
    ...
    public List<String> getBuildables() {
        ...
        if (wood >= BuildablesRequirements.getWoodRequiredForBow()
                && arrows >= BuildablesRequirements.getArrowsRequiredForBow()) {
            result.add("bow");
        }
        if (wood >= BuildablesRequirements.getWoodRequiredForShield()
                && (treasure >= BuildablesRequirements.getTreasureRequiredForShield()
                        || keys >= BuildablesRequirements.getKeysRequiredForShield())) {
            result.add("shield");
        }
        return result;
    }
