...
public class Game {
    ...
    public void init() {
        ...
        numInitialEnemies = map.getEntities(Enemy.class).size();
    ...
    public void battle(Player player, Enemy enemy) {
        ...
        // ((Hydra) enemy).randomIncreaseHealth();
        // }
    ...
    public List<Mercenary> getMercenaryFromMap() {
        return getMap().getEntities(Mercenary.class);
    }

    public List<Exit> getExitFromMap() {
        return getMap().getEntities(Exit.class);
    }

    public List<Switch> getSwitchFromMap() {
        return getMap().getEntities(Switch.class);
    }

    public void removeInventoryItemFromPlayer(InventoryItem item) {
        getPlayer().remove(item);
    }

    public void enableSpawnZombie(Game game, ZombieToastSpawner spawner) {
        getEntityFactory().spawnZombie(game, spawner);
    }

    public <T extends Entity> List<T> getEntityType(Class<T> type) {
        return map.getEntities(type);
    }

    public int getNumInitialEnemies() {
        return numInitialEnemies;
    }
